...
contract DeployMockTokens is Script {
    function run() external {
        ...
        address usdcProxy = factory.createToken("USD Coin", "USDC", 8, 1_000_000, deployer);
        ...
        address daiProxy = factory.createToken("Dai Stablecoin", "DAI", 16, 1_000_000, deployer);
        ...
        address wbtcProxy = factory.createToken("Wrapped Bitcoin", "WBTC", 18, 1_000_000, deployer);
